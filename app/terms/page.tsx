    ...
    <main className="min-h-screen bg-[#FDFAF6]">
      ...
      <div className="border-b border-[#E5E0D8] bg-white">
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <h1 className="text-[32px] font-extrabold tracking-tight text-gray-900">Terms of Service</h1>
      ...
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="max-w-2xl space-y-10">
          ...
          <LegalSection number="1" title="Service description">
            <p>
          ...
          <LegalSection number="2" title="AI-generated content disclaimer">
            <p>
          ...
          <LegalSection number="3" title="Payments and credits">
          ...
          <LegalSection number="4" title="Refund policy">
            <p>
